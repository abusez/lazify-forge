...
public class LazifyMod {
    ...
    public static final String VERSION = "260816";
    ...
    public void init(FMLInitializationEvent event) {
        int overlayKey = LazifyConfig.INSTANCE.getKeybind();
        guiKeybind = new KeyBinding("Lazify Settings", Keyboard.KEY_L, "Lazify");
        overlayKeybind = new KeyBinding("Lazify Overlay", overlayKey, "Lazify");
