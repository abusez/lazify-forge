...
public class LazifyConfig {
    ...
    private String  colOrder      = "encounters,username,rank,star,fkdr,winstreaks,urchin,session,ping,level";
    ...
    private int overlayTheme         = 0;   // 0=Default 1=Nerdify
    ...
    public void syncFromFile() {
        ...
        p = config.get("columns", "colOrder", "encounters,username,rank,star,fkdr,winstreaks,urchin,session,ping,level");
        ...
        p.comment = "Overlay visual theme. 0 = Default (configurable hues), 1 = Nerdify (terminal green).";
    ...
    public void setOverlayTheme(int v)             { overlayTheme = v; }
